---
title: "learn-claude-code/README-zh.md at main"
source: "https://github.com/shareAI-lab/learn-claude-code/blob/main/README-zh.md"
author:
published:
created: 2026-05-06
description: "Bash is all you need -  A nano claude code–like 「agent harness」, built from 0 to 1 - learn-claude-code/README-zh.md at main · shareAI-lab/learn-claude-code"
tags:
  - "clippings"
---
## Learn Claude Code -- 真正的 Agent Harness 工程

[English](https://github.com/shareAI-lab/learn-claude-code/blob/main/README.md) | [中文](https://github.com/shareAI-lab/learn-claude-code/blob/main/README-zh.md) | [日本語](https://github.com/shareAI-lab/learn-claude-code/blob/main/README-ja.md)
...
| 课程 | 主题 | 格言 |
| --- | --- | --- |
| [s01](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s01-the-agent-loop.md) | Agent Loop | *One loop & Bash is all you need* |
| [s02](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s02-tool-use.md) | Tool Use | *加一个工具, 只加一个 handler* |
| [s03](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s03-todo-write.md) | TodoWrite | *没有计划的 agent 走哪算哪* |
| [s04](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s04-subagent.md) | Subagent | *大任务拆小, 每个小任务干净的上下文* |
| [s05](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s05-skill-loading.md) | Skills | *用到什么知识, 临时加载什么知识* |
| [s06](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s06-context-compact.md) | Context Compact | *上下文总会满, 要有办法腾地方* |
| [s07](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s07-task-system.md) | Task System | *大目标要拆成小任务, 排好序, 记在磁盘上* |
| [s08](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s08-background-tasks.md) | Background Tasks | *慢操作丢后台, agent 继续想下一步* |
| [s09](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s09-agent-teams.md) | Agent Teams | *任务太大一个人干不完, 要能分给队友* |
| [s10](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s10-team-protocols.md) | Team Protocols | *队友之间要有统一的沟通规矩* |
| [s11](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s11-autonomous-agents.md) | Autonomous Agents | *队友自己看看板, 有活就认领* |
| [s12](https://github.com/shareAI-lab/learn-claude-code/blob/main/docs/zh/s12-worktree-task-isolation.md) | Worktree + Task Isolation | *各干各的目录, 互不干扰* |
